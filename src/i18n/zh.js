...
export default {
  ...
  'header.githubTitle': '仓库链接占位符 —— 请替换 components/Header.jsx 里的 GITHUB_URL',
  'header.githubAria': 'GitHub 仓库（占位链接）',
  'header.about': '关于',
  ...
  'about.intro':
    'ThemeForge 是一个免费、无需登录的 Chrome 主题生成器。选好颜色、看实时预览，几秒内就能下载一个可直接加载的主题 ZIP。',
